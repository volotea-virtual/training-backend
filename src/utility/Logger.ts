...
function log(LogLevel = LogLevels.LOG_DEFAULT, message: string, showDate: boolean = false, customPre: string | null = null) {
    if (customPre == null) {
...
export default { log, logToFile, clearLogEntries}